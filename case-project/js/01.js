...
$(function () {
    ...
    function createItem(arr) {           //根据传入的数组内容   去渲染 item
        ...
        arr.forEach(function (e) {
            ...
            //替换成 自己的 HTML ⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐
            let neirong = $("<div class=\"neirong-top \">\n" +
                "                        <div class=\"nei-top-left \">\n" +
                "                            <div class=\"left-top \">"+left-top+"</div>\n" +
                "                            <div class=\"left-bottom \">"+left-top+"</div>\n" +
                "                        </div>\n" +
                "                        <div class=\"nei-top-center \">"+nei-top-center+"</div>\n" +
                "                        <div class=\"nei-top-right  xy-center\">"+nei-top-right+"</div>\n" +
                "                    </div>\n" +
